...
const GetReportLockers = async (payload) => {
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            const response = await axios.post(API_ROUTES.REPORT_LOCKERS, payload, { timeout: effectiveTimeout });
...
export default GetReportLockers;
