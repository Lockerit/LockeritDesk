...
const fileName = 'openSessionLocker'; // Nombre del archivo para los logs
...
export const OpenSessionLocker = async (payload) => {
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            const response = await instanceAxios.post(API_ROUTES.OPEN_SESSION_LOCKER, payload, { timeout: effectiveTimeout });
